...
public final class ShortcutFile {
    ...
    public ShortcutInfo getShortcutInfo(Context context, boolean showToastForIconUsed) {
        ...
        if (shortcutIconFile != null)
            ...
            builder.setIcon(Icon.createWithResource(context, R.mipmap.ic_launcher)); // shiroikuma-termux: the app's icon
    ...
    public Intent getStaticShortcutIntent(Context context) {
        ...
        if (shortcutIconFile != null)
            ...
            intent.putExtra(Intent.EXTRA_SHORTCUT_ICON_RESOURCE, Intent.ShortcutIconResource.fromContext(context, R.mipmap.ic_launcher)); // shiroikuma-termux: the app's icon
    ...
    public RemoteViews getListWidgetView(Context context) {
        ...
        // shiroikuma-termux: text colour and size from the Widget section of the 白い熊 Termux UI page
        remoteViews.setTextColor(R.id.widget_item, ShiroikumaTheme.color(context, ShiroikumaTheme.WIDGET_TEXT));
        remoteViews.setTextViewTextSize(R.id.widget_item, TypedValue.COMPLEX_UNIT_SP,
                ShiroikumaTheme.value(context, ShiroikumaTheme.WIDGET_TEXT_SIZE_SP));
