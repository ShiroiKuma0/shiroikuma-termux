...
public class FloatingBubbleManager {
    ...
    public void updateLongPressBackgroundResource(boolean isInLongPressState) {
        ...
        mTermuxFloatView.applyWindowStyle(isInLongPressState); // shiroikuma-termux: the UI page's frame, red-stroked while resizing
    }
    ...
    public void displayAsFloatingWindow() {
        ...
        TermuxFloatView termuxFloatView = getTermuxFloatView();
        termuxFloatView.applyWindowStyle(false); // shiroikuma-termux: instead of the captured background (+ clipToOutline per the corner radius)
